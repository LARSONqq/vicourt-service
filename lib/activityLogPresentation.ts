...
> = {
  ...
  "equipment.created": [
    { kind: "value", label: "Категорія", key: "category" },
    { kind: "value", label: "Інвентарний номер", key: "inventory_number" },
    { kind: "value", label: "Статус", key: "status" },
    { kind: "value", label: "Відповідальний", key: "responsible" },
    { kind: "value", label: "Розташування", key: "location" },
    { kind: "value", label: "Дата придбання", key: "purchase_date", format: "date" },
  ],
  "equipment.updated": [
    { kind: "change", label: "Назва", previousKey: "previous_name", newKey: "new_name" },
    { kind: "change", label: "Категорія", previousKey: "previous_category", newKey: "new_category" },
    { kind: "change", label: "Інвентарний номер", previousKey: "previous_inventory_number", newKey: "new_inventory_number" },
    { kind: "change", label: "Статус", previousKey: "previous_status", newKey: "new_status" },
    { kind: "change", label: "Відповідальний", previousKey: "previous_responsible", newKey: "new_responsible" },
    { kind: "change", label: "Розташування", previousKey: "previous_location", newKey: "new_location" },
    { kind: "change", label: "Дата придбання", previousKey: "previous_purchase_date", newKey: "new_purchase_date", format: "date" },
    { kind: "value", label: "Примітки змінено", key: "notes_changed", format: "boolean" },
  ],
  "equipment.deleted": [
    { kind: "value", label: "Категорія", key: "category" },
    { kind: "value", label: "Інвентарний номер", key: "inventory_number" },
    { kind: "value", label: "Останній статус", key: "status" },
    { kind: "value", label: "Відповідальний", key: "responsible" },
    { kind: "value", label: "Останнє розташування", key: "location" },
  ],
