...
export const activityEventRegistry = {
  ...
  "task_template.created": { label: "Створено шаблон завдання", category: "tasks", icon: "🔁" },
  "task_template.updated": { label: "Оновлено шаблон завдання", category: "tasks", icon: "✏️" },
  "task_template.disabled": { label: "Вимкнено серію завдань", category: "tasks", icon: "⏸️" },
  ...
  "material.returned_to_warehouse": { label: "Повернено матеріал на склад", category: "warehouse", icon: "↩️" },
  ...
  "warehouse_item.stock_adjusted": { label: "Скориговано залишок складу", category: "warehouse", icon: "⚖️" },
  "warehouse_item.deleted": { label: "Видалено позицію складу", category: "warehouse", icon: "🗑️" },
  "equipment.created": { label: "Створено техніку", category: "equipment", icon: "🛠️" },
  "equipment.updated": { label: "Оновлено техніку", category: "equipment", icon: "✏️" },
  "equipment.deleted": { label: "Видалено техніку", category: "equipment", icon: "🗑️" },
